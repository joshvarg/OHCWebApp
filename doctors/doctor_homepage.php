            ...
            <div class="container">
                ...
                <div class="container">
                    ...
                    while($row1 = mysqli_fetch_array($result1)) {
                        ...
                        $sql2 = 'select tName from doctor_treatment, practices_at, treatment where doctor_treatment.dssn = \''.$dSSN.'\' and doctor_treatment.tHID=\''.$row1["hospitalID"].'\' and doctor_treatment.dtCode = treatment.treatmentCode';
                        $result2 = mysqli_query($conn, $sql2);
                        while($row2 = mysqli_fetch_array($result2)) {
                            echo '<div class="col text display style=margin-top: 10px">';
                            echo '<div class="col text display" style="font-family:\'Gill Sans\', \'Gill Sans MT\', Calibri, \'Trebuchet MS\', sans-serif"><strong>', $row2["tName"],'</strong></div>';
                            echo '</div>';
                        }
                        ...
                        echo '</div>';
                        $sql3 = 'select time, day from schedule where schedule.dssn = \''.$dSSN.'\' and schedule.HospitalID=\''.$row1["hospitalID"].'\'';
